              ...
              <div className="grid grid-cols-3 gap-3">
                <div className="form-field">
                  ...
                  <div className="flex gap-2">
                    <input type="number" value={batchSize} onChange={(e) => setBatchSize(Number(e.target.value))} className="flex-1" min={0} />
                    <select value={batchUnit} onChange={(e) => setBatchUnit(e.target.value)} className="w-20">
